...
```bash
# Clone the repo
git clone https://github.com/YOUR_USERNAME/agentforge-pro.git
...
**[AgentForge Pro](https://payhip.com/YOUR_STORE)** includes:
...
[Get AgentForge Pro →](https://payhip.com/YOUR_STORE)
